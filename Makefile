...
SRC_FILES += src/html/html.c src/json/json.c src/readline/readline.c src/utils/utils.c src/lua.c src/modules.c
...
TEST_SRC += src/html/html.c src/json/json.c src/readline/readline.c src/utils/utils.c src/lua.c src/modules.c
